...
def save_intent_config(selector: IntentModelSelector, config_path: str) -> None:
    ...
    config = {"intent_detection_model": selector.intent_detection_model, "intents": {}}
    ...
    for mapping in selector.intent_mappings:
        ...
        if mapping.model_pair is not None:
            entry["models"] = {"strong": mapping.model_pair.strong, "weak": mapping.model_pair.weak}
...
def create_example_config(config_path: str) -> None:
    ...
    example_config = {
        ...
        "default_models": {"strong": "gpt-4", "weak": "gpt-3.5-turbo"},
        "intents": {
            "marketing": {
                "description": "Marketing content creation for digital products",
                "models": {"strong": "gpt-4-turbo", "weak": "gpt-3.5-turbo"},
            },
            "copywriting": {
                "description": "Ghost copywriting for blogs and articles",
                "models": {"strong": "claude-3-opus", "weak": "claude-3-sonnet"},
            },
            "technical": {
                "description": "Technical documentation and code explanation",
                "models": {"strong": "gpt-4-turbo", "weak": "mistralai/Mixtral-8x7B-Instruct-v0.1"},
            },
        },
    }
