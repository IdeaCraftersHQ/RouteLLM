...
class DomainIntentDetector:
    ...
    def _save_cache(self) -> None:
        ...
        serializable_cache = {
            text: embedding.tolist() for text, embedding in self.embedding_cache.items()
        }
    ...
    def detect_intent(self, prompt: str) -> str:
        ...
        for intent, embeddings in self.intent_embeddings.items():
            ...
            similarities = [
                cosine_similarity(
                    prompt_embedding.reshape(1, -1), example_embedding.reshape(1, -1)
                )[0][0]
    ...
    def get_intent_confidence(self, prompt: str) -> dict[str, float]:
        ...
        if total_score > 0:
            intent_scores = {intent: score / total_score for intent, score in intent_scores.items()}
